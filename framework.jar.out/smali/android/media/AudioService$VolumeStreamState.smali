...
.method public applyAllVolumes()V
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$3400(Landroid/media/AudioService;)Z
...
.method public applyDeviceVolume(I)V
    ...
    # getter for: Landroid/media/AudioService;->mUseMasterVolume:Z
    invoke-static {v3}, Landroid/media/AudioService;->access$3400(Landroid/media/AudioService;)Z
...
.method public readSettings()V
    ...
    const-string/jumbo v9, "readSettings: mUseMasterVolume=1, set DEVICE_OUT_DEFAULT to "
    ...
    const-string v9, ", mVolumeIndexSettingName="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v9, p0, Landroid/media/AudioService$VolumeStreamState;->mVolumeIndexSettingName:Ljava/lang/String;
    ...
    # getter for: Landroid/media/AudioService;->mUseMasterVolume:Z
    invoke-static {v10}, Landroid/media/AudioService;->access$3400(Landroid/media/AudioService;)Z
...
.method public setIndex(II)Z
    ...
    # getter for: Landroid/media/AudioService;->mCameraSoundForced:Ljava/lang/Boolean;
    invoke-static {v9}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Ljava/lang/Boolean;
