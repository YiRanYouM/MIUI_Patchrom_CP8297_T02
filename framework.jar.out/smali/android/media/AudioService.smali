...
.field private static final MSG_MEETING_MODE_FORBID_ADJUST_VOLUME_DISPLAY:I = 0x17

.field private static final MSG_MUTE_MUSIC:I = 0x1f
...
.field private static final MSG_SET_PARAMETERS:I = 0x1e

.field private static final MSG_SET_WIRED_DEVICE_CONNECTION_STATE:I = 0x64

.field private static final MSG_SILENT_MODE_FORBID_ADJUST_VOLUME_DISPLAY:I = 0x16

.field private static final MSG_SPEAKER_MUTEKEY_FORBID_ADJUST_VOLUME_DISPLAY:I = 0x15
...
.field private final mVolumeStreamStateRingDtmfLock:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    .line 566
    sput-object v3, Landroid/media/AudioService;->oSystemManager:Ljava/lang/Object;

    .line 567
    sput-object v3, Landroid/media/AudioService;->mGetCurrentModel:Ljava/lang/reflect/Method;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v3, "STREAM_INCALL_MUSIC"
    ...
    .line 511
    iput-boolean v6, p0, Landroid/media/AudioService;->fmIsActive:Z
    ...
    .line 571
    iput-boolean v13, p0, Landroid/media/AudioService;->mFirstConnection:Z
    ...
    iput-object v0, p0, Landroid/media/AudioService;->mVolumeStreamStateRingDtmfLock:Ljava/lang/Object;
    ...
    const-string v2, " mSafeMediaVolumeIndex "
    ...
    const-string v1, "coolpadSystem"

    invoke-virtual {v0, v1}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/yulong/android/server/systeminterface/SystemManager;

    .line 735
    .local v10, "mSystemManager":Lcom/yulong/android/server/systeminterface/SystemManager;
    invoke-virtual {v10}, Lcom/yulong/android/server/systeminterface/SystemManager;->getCurrentModel()I
    ...
    .line 736
    iput-boolean v13, p0, Landroid/media/AudioService;->mUseMasterVolume:Z

    .line 739
    :cond_0
    const-string v0, "1"

    const-string/jumbo v1, "persist.audio.oldman.on"
    ...
    const-string v2, "AudioServicemUseMasterVolume:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Landroid/media/AudioService;->mUseMasterVolume:Z
    ...
    const-string v2, "AudioService ctor mUseMasterVolume:"
    ...
    .local v8, "i":I
    :goto_2
    iget-object v0, p0, Landroid/media/AudioService;->mMasterVolumeRamp:[I
    ...
    const-string/jumbo v2, "mMasterVolumeRamp["
    ...
    iget-object v2, p0, Landroid/media/AudioService;->mMasterVolumeRamp:[I
    ...
    .end local v10    # "mSystemManager":Lcom/yulong/android/server/systeminterface/SystemManager;
    :cond_4
    ...
    .restart local v10    # "mSystemManager":Lcom/yulong/android/server/systeminterface/SystemManager;
    :cond_6
    const-string v0, "AudioService"
    ...
    const-string/jumbo v2, "mMasterVolumeRamp.length "
...
.method static synthetic access$7500(Landroid/media/AudioService;)Landroid/widget/Toast;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$7502(Landroid/media/AudioService;Landroid/widget/Toast;)Landroid/widget/Toast;
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$7600(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$8702(Landroid/media/AudioService;Z)Z
    ...
    .prologue
    .line 144
    iput-boolean p1, p0, Landroid/media/AudioService;->fmIsActive:Z

    return p1
.end method

.method private adjustMasterVolume_oldman(IILjava/lang/String;)V
    .locals 15
    .param p1, "steps"    # I
    .param p2, "flags"    # I
    ...
    .prologue
    .line 1309
    iget-boolean v12, p0, Landroid/media/AudioService;->mUseFixedVolume:Z
    ...
    iget-object v12, p0, Landroid/media/AudioService;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    .line 1323
    :cond_2
    invoke-direct/range {p0 .. p1}, Landroid/media/AudioService;->ensureValidSteps(I)V
    ...
    .line 1326
    .local v11, "volume":I
    sget-object v12, Landroid/media/AudioService;->MAX_STREAM_VOLUME:[I
    ...
    .line 1331
    invoke-direct {p0, v3, v11}, Landroid/media/AudioService;->findVolumeDelta(II)I
    ...
    sget-object v13, Landroid/media/AudioService;->MAX_STREAM_VOLUME:[I
    ...
    const-string/jumbo v14, "sendVolumeUpdate: StreamType = "
    ...
    .line 1342
    invoke-virtual {p0, v5}, Landroid/media/AudioService;->sendBroadcastToAll(Landroid/content/Intent;)V

    .line 1347
    .end local v5    # "intent":Landroid/content/Intent;
    .end local v7    # "newStreamIndex":I
    :cond_5
    move/from16 v0, p2

    move-object/from16 v1, p3

    invoke-virtual {p0, v11, v0, v1}, Landroid/media/AudioService;->setMasterVolume(IILjava/lang/String;)V
...
.method private checkForRingerModeChange(III)Z
    ...
    const-string v4, "checkForRingerModeChange oldIndex:"
    ...
    const-string v4, "checkForRingerModeChange ringerMode:"
    ...
    const-string v4, " adjustVolumeIndex:"
...
.method private checkSafeMediaVolume(III)Z
    ...
    const-string v3, "checkSafeMediaVolume index "
...
.method private createStreamStates()V
    ...
    const-string v5, "createStreamStates() numStreamTypes =:"
...
.method private doSetMasterVolume(FI)V
    ...
    const-string v3, "doSetMasterVolume, mUseMasterVolume="

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v3, p0, Landroid/media/AudioService;->mUseMasterVolume:Z
...
.method private enforceSafeMediaVolume()V
    ...
    const-string v4, "enforceSafeMediaVolume current index "
...
.method private ensureValidStreamType(I)V
    ...
    const-string v2, "AudioService::ensureValidStreamType streamType:"
    ...
    const-string v2, "--mUseMasterVolume:"
...
.method private getActiveStreamType(I)I
    ...
    const-string v1, "getActiveStreamType: Forcing STREAM_FM stream active"
...
.method private getCurrentModel()I
    ...
    sget-object v5, Landroid/media/AudioService;->oSystemManager:Ljava/lang/Object;

    if-eqz v5, :cond_0

    sget-object v5, Landroid/media/AudioService;->mGetCurrentModel:Ljava/lang/reflect/Method;
    ...
    const-string v6, "getCurrentModel() system manager is not init"
    ...
    sget-object v6, Landroid/media/AudioService;->oSystemManager:Ljava/lang/Object;
    ...
    .line 638
    .local v4, "modeTemp":Ljava/lang/Integer;
    ...
    .end local v4    # "modeTemp":Ljava/lang/Integer;
    :goto_1
    move v5, v0
...
.method private handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    const-string v6, "handleDeviceConnection  connected is "
    ...
    const-string v6, " preConnected is "
    ...
    .line 4740
    iget-boolean v1, p0, Landroid/media/AudioService;->mFirstConnection:Z
    ...
    iput-boolean v1, p0, Landroid/media/AudioService;->mFirstConnection:Z
...
.method private onCheckMusicActive()V
    ...
    const-string/jumbo v2, "on check music active "
...
.method private onConfigureSafeVolume(Z)V
    ...
    const-string/jumbo v2, "onConfigureSafeVolume mcc "
    ...
    const-string/jumbo v2, "onConfigureSafeVolume mSafeMediaVolumeIndex "
    ...
    const-string v2, " safeMediaVolumeEnabled "
...
.method private onSetA2dpConnectionState(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    .line 4631
    .end local v11    # "scenemodelmetting":Z
    .end local v12    # "scenemodelquiet":Z
    :cond_0
    const/4 v12, 0x0
    ...
    .line 4632
    .restart local v12    # "scenemodelquiet":Z
    :cond_1
    const/4 v11, 0x0
    ...
    .line 4637
    .restart local v11    # "scenemodelmetting":Z
    :cond_2
    ...
    const-string v3, "disconnect A2dp Device,but headset or headphone is connected,make master volume to 100, state= "
    ...
    const-string v3, "disconnect A2dp Device,but headset or headphone is disconnected,make master volume to 0, state= "
    ...
    const-string v3, "connect A2dp Device,make master volume to 100, state= "
    ...
    invoke-direct {p0, v1, v2}, Landroid/media/AudioService;->doSetMasterVolume(FI)V
    ...
    iput-object v10, v1, Landroid/media/AudioRoutesInfo;->mBluetoothName:Ljava/lang/CharSequence;
...
.method private readPersistedSettings()V
    ...
    .line 976
    :cond_3
    const-string/jumbo v8, "persist.yulong.ctstest"
    ...
    .line 983
    .local v1, "ctsflag":Ljava/lang/String;
    ...
    invoke-static {v0, v8, v9, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v0, v8, v7, v12}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method private restoreMasterVolume()V
    ...
    const-string/jumbo v3, "restoreMasterVolume : "
...
.method private setSafeMediaVolumeEnabled(Z)V
    ...
    const-string/jumbo v2, "setSafeMediaVolumeEnabled state "
...
.method private setStreamVolumeInt(IIIZ)V
    ...
    const-string/jumbo v3, "setStreamVolumeInt stmType: "
...
.method public adjustMasterVolume(IILjava/lang/String;)V
    ...
    .line 1358
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Landroid/media/AudioService;->adjustMasterVolume_oldman(IILjava/lang/String;)V
...
.method public adjustStreamVolume(IIILjava/lang/String;)V
    ...
    const-string v6, ", mUseMasterVolume="
    ...
    iget-boolean v6, v0, Landroid/media/AudioService;->mUseMasterVolume:Z
    ...
    iget-boolean v4, v0, Landroid/media/AudioService;->mUseMasterVolume:Z
    ...
    const-string v6, "adjustStreamVolume() direction="
    ...
    const-string v6, ", mUseMasterVolume=1"
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/media/AudioService;->adjustMasterVolume(IILjava/lang/String;)V
    ...
    .line 1145
    const-string/jumbo v4, "persist.yulong.ctstest"
    ...
    .line 1147
    .local v13, "ctsflag":Ljava/lang/String;
    const-string v4, "0"
    ...
    iget-object v4, v0, Landroid/media/AudioService;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    :cond_3
    const-string/jumbo v4, "persist.sys.hallsensor.switch"
    ...
    const-string/jumbo v5, "when keyguard lock or hallsensor closed,can\'t ajust ring volume!"
    ...
    sget v5, Landroid/media/AudioService;->c_quietmode:I
    ...
    .line 1157
    .local v19, "scenemodelquiet":Z
    :goto_1
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->getCurrentModel()I

    move-result v4

    sget v5, Landroid/media/AudioService;->c_meetingmode:I
    ...
    sget-boolean v4, Landroid/media/AudioManager;->speaker_mute_state:Z
    ...
    const-string v6, ">>>>>isAnyConnected = "
    ...
    const-string v6, ",AudioSystem.getMasterVolume() = "
    ...
    const-string v5, "Even in quiet or meeting mode,but headset is connected!"

    invoke-static {v4, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1204
    .end local v15    # "isAnyConnected":Z
    :cond_a
    move-object/from16 v0, p0
    ...
    iget-object v4, v0, Landroid/media/AudioService;->mVolumePanel:Landroid/view/VolumePanel;

    move/from16 v0, p3

    invoke-virtual {v4, v0}, Landroid/view/VolumePanel;->postDisplaySafeVolumeWarning(I)V
    ...
    const-string v6, "change volume index from oldindex "
    ...
    const-string/jumbo v6, "to newindex "
    ...
    .end local v18    # "scenemodelmetting":Z
    .end local v19    # "scenemodelquiet":Z
    ...
    .line 1157
    .restart local v19    # "scenemodelquiet":Z
    :cond_14
    const/16 v18, 0x0
    ...
    .line 1162
    .restart local v18    # "scenemodelmetting":Z
    :cond_15
    const/4 v15, 0x0
    ...
    .line 1179
    .restart local v15    # "isAnyConnected":Z
    :cond_16
    sget-boolean v4, Landroid/media/AudioManager;->speaker_mute_state:Z
    ...
    const-string v5, " can not adjust stream volume in speaker_mutekey mode"
    ...
    const-string v5, " can not adjust stream volume in silent mode"
    ...
    const-string v5, " can not adjust stream volume in meeting mode"
    ...
    .restart local v12    # "aliasIndex":I
...
.method public dispatchMediaKeyEvent(Landroid/view/KeyEvent;)V
    ...
    const-string v2, "dispatch MediaKey Event keycode "
...
.method public dispatchMediaKeyEventUnderWakelock(Landroid/view/KeyEvent;)V
    ...
    const-string v2, "dispatch MediaKey Event Under Wakelock keycode "
...
.method public setBluetoothA2dpOn(Z)V
    ...
    const-string/jumbo v2, "set a2dp on "
...
.method public setBluetoothScoOn(Z)V
    ...
    const-string v1, "mForcedUseForComm != FORCE_BT_SCO, ignore setBluetoothScoOn(false)!"
    ...
    const-string/jumbo v6, "set sco on "
...
.method public setMasterVolume(IILjava/lang/String;)V
    ...
    const-string/jumbo v2, "setMasterVolume volume: "
...
.method public setMode(ILandroid/os/IBinder;)V
    ...
    .line 2079
    iget-object v2, p0, Landroid/media/AudioService;->mVolumeStreamStateRingDtmfLock:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v3, p0, Landroid/media/AudioService;->mSetModeDeathHandlers:Ljava/util/ArrayList;
...
.method public setSpeakerphoneOn(Z)V
    ...
    const-string/jumbo v6, "set speaker phone on "
...
.method public setStreamVolume(IIILjava/lang/String;)V
    ...
    iget-object v9, p0, Landroid/media/AudioService;->mVolumeStreamStateRingDtmfLock:Ljava/lang/Object;
    ...
    .end local v7    # "streamState":Landroid/media/AudioService$VolumeStreamState;
    ...
    .restart local v7    # "streamState":Landroid/media/AudioService$VolumeStreamState;
    ...
    const-string v1, "can not set stream volume above safe media volume,pengding it"
...
.method public setVibrateSetting(II)V
    ...
    .line 1991
    :cond_0
    iget v1, p0, Landroid/media/AudioService;->mVibrateSetting:I

    invoke-static {v1, p1, p2}, Landroid/media/AudioService;->getValueForVibrateSetting(III)I
...
.method public setWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    .line 3424
    :try_start_0
    iget-boolean v0, p0, Landroid/media/AudioService;->fmIsActive:Z
    ...
    .line 3426
    const-string v0, "fm_volume=0.0000000000"
...
.method public shouldVibrate(I)Z
    ...
    const-string/jumbo v5, "vibrate setting "
...
.method public startBluetoothSco(Landroid/os/IBinder;I)V
    ...
    const-string/jumbo v4, "start blue tooth sco"
...
.method public stopBluetoothSco(Landroid/os/IBinder;)V
    ...
    const-string/jumbo v4, "stop blue tooth sco"
