...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/media/AudioManager;->speaker_mute_state:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 491
    .local v0, "mSystemManager":Lcom/yulong/android/server/systeminterface/SystemManager;
    invoke-virtual {v0}, Lcom/yulong/android/server/systeminterface/SystemManager;->getCurrentModel()I
    ...
    .line 493
    iput-boolean v4, p0, Landroid/media/AudioManager;->mUseMasterVolume:Z
    ...
    const-string/jumbo v3, "old model::  useMasterVolume "
    ...
    const-string/jumbo v2, "persist.audio.oldman.on"
    ...
    const-string v3, "AudioManager ctor mUseMasterVolume:"
...
.method public getStreamVolume(I)I
    ...
    .line 835
    invoke-interface {v4, p1}, Landroid/media/IAudioService;->getStreamMaxVolume(I)I

    move-result v3

    .line 836
    .local v3, "maxStreamVolume":I
    invoke-interface {v4}, Landroid/media/IAudioService;->getMasterVolume()I

    move-result v1

    .line 837
    .local v1, "masterVolume":I
    invoke-interface {v4}, Landroid/media/IAudioService;->getMasterMaxVolume()I

    move-result v2

    .line 838
    .local v2, "maxMasterVolume":I
    int-to-float v6, v1
    ...
    const-string v8, "getStreamVolume: streamVolume = "
    ...
    .line 850
    .end local v1    # "masterVolume":I
    .end local v2    # "maxMasterVolume":I
    .end local v3    # "maxStreamVolume":I
    ...
    .line 846
    :cond_0
    invoke-interface {v4, p1}, Landroid/media/IAudioService;->getStreamVolume(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, "Dead object in getStreamVolume"
...
.method public setStreamVolume(III)V
    ...
    const-string/jumbo v6, "setStreamVolume: StreamType = "
    ...
    invoke-interface {v3}, Landroid/media/IAudioService;->getMasterMaxVolume()I
    ...
    const-string/jumbo v6, "setStreamVolume: masterIndex = "
    ...
    invoke-interface {v3, v1, p3, v4}, Landroid/media/IAudioService;->setMasterVolume(IILjava/lang/String;)V

    .line 949
    .end local v1    # "masterIndex":I
    ...
    invoke-interface {v3, p1, p2, p3, v4}, Landroid/media/IAudioService;->setStreamVolume(IIILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "Dead object in setStreamVolume"
