...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    .line 127
    iput-boolean v1, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mPBMReady:Z
...
.method public dispose()V
    ...
    .line 232
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/IccRecords;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    .line 233
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mPBMReady:Z
...
.method public fetchCardSmsAndPBM(I)V
    ...
    const-string v3, "IccRecords:fetchCardSmsAndPBM :"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardInitState:I
    ...
    .line 467
    iput v5, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCurReadIndex:I

    .line 468
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mReadSmsTotal:I

    .line 469
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardSmsUsed:I

    .line 470
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardSmsMax:I

    .line 471
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->bCardAdnInited:Z

    .line 472
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mReadAdnTotal:I

    .line 473
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnUsed:I

    .line 474
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnMax:I

    .line 475
    iput v5, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCurReadIndex:I

    .line 476
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnNumberMax:I

    .line 477
    iput v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnNameMax:I

    .line 478
    const/16 v2, 0xa

    iput v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mMaxReadCount:I

    .line 480
    invoke-virtual {p0, v4, v4, v6}, Lcom/android/internal/telephony/uicc/IccRecords;->handleSmsParam(III)V

    .line 481
    invoke-virtual {p0, v4, v4, v6}, Lcom/android/internal/telephony/uicc/IccRecords;->handlePbParam(III)V
    ...
    .line 492
    :pswitch_2
    iget-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->isRefresh:Z

    if-eqz v2, :cond_0

    .line 493
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->isRefresh:Z

    .line 494
    const-string v2, "IccRecords:fetchCardSmsAndPBM Sleep for refresh"
    ...
    .line 505
    sput-boolean v4, Lcom/android/internal/telephony/uicc/IccRecords;->isNewSms:Z

    .line 506
    iget v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCurReadIndex:I

    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/IccRecords;->getAllCardSms(I)V
    ...
    invoke-static {v2, v7, v7}, Lcom/yulong/android/internal/telephony/TelephonyCommFeature;->notifyToBugReport(Ljava/lang/String;Ljava/lang/String;Landroid/app/ApplicationErrorReport$CrashInfo;)V
    ...
    .line 526
    iget v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnMax:I

    iget v3, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCardAdnUsed:I

    invoke-virtual {p0, v2, v3, v5}, Lcom/android/internal/telephony/uicc/IccRecords;->handlePbParam(III)V
    ...
    const-string v3, "yulong.contact.simrecord.ready"
...
.method public getCardAllPBMInfo()V
    ...
    .line 436
    :cond_0
    const-string v1, "getCardAllPBMInfo: is usim 3G"
    ...
    .local v0, "efid":I
    :goto_0
    new-instance v1, Lcom/android/internal/telephony/uicc/IccRecords$1;

    invoke-direct {v1, p0, v0}, Lcom/android/internal/telephony/uicc/IccRecords$1;-><init>(Lcom/android/internal/telephony/uicc/IccRecords;I)V

    invoke-virtual {v1}, Lcom/android/internal/telephony/uicc/IccRecords$1;->start()V
    ...
    .end local v0    # "efid":I
    :cond_1
    const-string v1, "getCardAllPBMInfo: is sim 2G or CARD_IMPORT_TYPE_AT"
...
.method public getCardSmsParam()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/IccRecords;->obtainMessage(I)Landroid/os/Message;
...
.method public abstract getMLPLVersion()I
.end method

.method public abstract getMSPLVersion()I
.end method
...
.method public getRecordsLoaded()Z
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->bCardAdnInited:Z
...
.method public getYLImsi()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/yulong/android/internal/telephony/PhoneModeService;->getImsi(I)Ljava/lang/String;
...
.method public isPBMReady()Z
    .locals 1

    .prologue
    .line 851
    iget-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mPBMReady:Z
...
.method public abstract setSMSCAddr(Ljava/lang/String;Landroid/os/Message;)V
.end method
