...
.field private static final MSG_LOAD_INCHINA_PROVIDER:I = 0x62

.field private static final MSG_LOAD_OUTCHINA_PROVIDER:I = 0x64

.field private static final MSG_LOAD_PROVIDER:I = 0x62

.field private static final MSG_LOCATION_CHANGED:I = 0x1

.field private static final MSG_LOCATION_DISABLED:I = 0x63
...
# instance fields
.field private fusedLocationProvider:Lcom/android/server/location/LocationProviderProxy;

.field private fusedLocationProvider_amap:Lcom/android/server/location/LocationProviderProxy;

.field private fusedLocationProvider_baidu:Lcom/android/server/location/LocationProviderProxy;

.field private fusedLocationProvider_google:Lcom/android/server/location/LocationProviderProxy;
...
.field private mGeocodeProvider_baidu:Lcom/android/server/location/GeocoderProxy;
...
.field private networkProvider:Lcom/android/server/location/LocationProviderProxy;

.field private networkProvider_amap:Lcom/android/server/location/LocationProviderProxy;

.field private networkProvider_baidu:Lcom/android/server/location/LocationProviderProxy;

.field private networkProvider_google:Lcom/android/server/location/LocationProviderProxy;

.field private providerPackageNames:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private providerPackageNames_amap:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private providerPackageNames_baidu:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private providerPackageNames_google:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 194
    iput-boolean v1, p0, Lcom/android/server/LocationManagerService;->sendMessage:Z
...
.method static synthetic access$2100(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;

    return-object v0
.end method

.method static synthetic access$2102(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderProxy;)Lcom/android/server/location/LocationProviderProxy;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Lcom/android/server/location/LocationProviderProxy;

    .prologue
    .line 105
    iput-object p1, p0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;
...
.method static synthetic access$2400(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderInterface;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Lcom/android/server/location/LocationProviderInterface;
...
.method static synthetic access$2502(Lcom/android/server/LocationManagerService;Lcom/android/server/location/GeocoderProxy;)Lcom/android/server/location/GeocoderProxy;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Lcom/android/server/location/GeocoderProxy;
...
.method static synthetic access$2600(Lcom/android/server/LocationManagerService;Lcom/android/server/location/LocationProviderInterface;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Lcom/android/server/location/LocationProviderInterface;
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->networkProvider_baidu:Lcom/android/server/location/LocationProviderProxy;

    return-object v0
.end method

.method static synthetic access$2800(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->networkProvider_amap:Lcom/android/server/location/LocationProviderProxy;

    return-object v0
.end method

.method static synthetic access$2900(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mGeocodeProvider_baidu:Lcom/android/server/location/GeocoderProxy;

    return-object v0
.end method

.method static synthetic access$300(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationProviderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->networkProvider_google:Lcom/android/server/location/LocationProviderProxy;

    return-object v0
.end method

.method static synthetic access$3000(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$400(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/GeocoderProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$500(Lcom/android/server/LocationManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->sendMessage:Z

    return v0
.end method

.method static synthetic access$502(Lcom/android/server/LocationManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 105
    iput-boolean p1, p0, Lcom/android/server/LocationManagerService;->sendMessage:Z

    return p1
.end method

.method static synthetic access$600(Lcom/android/server/LocationManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 105
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->isInChina()Z
...
.method private doesPackageHaveUid(ILjava/lang/String;)Z
    ...
    invoke-interface {v3, p2, v4, v5}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    :try_end_0
...
.method private isInChina()Z
    ...
    invoke-direct {v0, v4}, Lcom/yulong/android/telephony/CPTelephonyManager;-><init>(Landroid/content/Context;)V

    .line 2896
    .local v0, "mCPTelephonyManager":Lcom/yulong/android/telephony/CPTelephonyManager;
    const/4 v4, 0x1

    invoke-virtual {v0, v4}, Lcom/yulong/android/telephony/CPTelephonyManager;->getDualNetworkOperator(I)Ljava/lang/String;

    move-result-object v2

    .line 2897
    .local v2, "operator1":Ljava/lang/String;
    const/4 v4, 0x2
    ...
    .line 2898
    .local v3, "operator2":Ljava/lang/String;
    ...
    const-string v6, "isInChina operator1: "
...
.method private loadProvidersLocked()V
    ...
    .prologue
    .line 437
    new-instance v13, Lcom/android/server/location/PassiveProvider;

    move-object/from16 v0, p0

    invoke-direct {v13, v0}, Lcom/android/server/location/PassiveProvider;-><init>(Landroid/location/ILocationManager;)V

    .line 438
    .local v13, "passiveProvider":Lcom/android/server/location/PassiveProvider;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v13}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    iput-object v13, v0, Lcom/android/server/LocationManagerService;->mPassiveProvider:Lcom/android/server/location/PassiveProvider;
    ...
    .line 475
    .local v19, "providerPackageNames_baidu":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v18, Ljava/util/ArrayList;

    invoke-direct/range {v18 .. v18}, Ljava/util/ArrayList;-><init>()V

    .line 476
    .local v18, "providerPackageNames_amap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v20, Ljava/util/ArrayList;

    invoke-direct/range {v20 .. v20}, Ljava/util/ArrayList;-><init>()V

    .line 477
    .local v20, "providerPackageNames_google":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    const v2, 0x1070038
    ...
    .line 479
    .local v15, "pkgs_baidu":[Ljava/lang/String;
    const v2, 0x1070039
    ...
    .line 481
    .local v14, "pkgs_amap":[Ljava/lang/String;
    const v2, 0x1070023
    ...
    .line 483
    .local v16, "pkgs_google":[Ljava/lang/String;
    const v2, 0x1110031
    ...
    const-string v4, "certificates for location providers_baidu pulled from: "
    ...
    const-string v4, "certificates for location providers_amap pulled from: "
    ...
    const-string v4, "certificates for location providers_google pulled from: "
    ...
    const-string v4, "certificates for location providers enableOverlay  = "
    ...
    const-string v3, "location baidu provider start "
    ...
    const-string v4, "com.android.location.service.v2.NetworkLocationProvider"
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_baidu:Lcom/android/server/location/LocationProviderProxy;

    .line 507
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_baidu:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v4, "networkProvider_baidu = "
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->networkProvider_baidu:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v3, "location baidu provider end "
    ...
    const-string v3, "location amap provider start "
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_amap:Lcom/android/server/location/LocationProviderProxy;

    .line 521
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_amap:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v4, "networkProvider_amap = "
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->networkProvider_amap:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v3, "location amap provider end "
    ...
    const-string v3, "location google provider start "
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_google:Lcom/android/server/location/LocationProviderProxy;

    .line 535
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider_google:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v4, "networkProvider_google = "
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->networkProvider_google:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v3, "location google provider end "
    ...
    const-string v3, "no network location provider_baidu found"
    ...
    const-string v3, "no network location provider_amap found"
    ...
    const-string v3, "no network location provider_google found"
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    iget-object v3, v0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    iget-object v2, v0, Lcom/android/server/LocationManagerService;->networkProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v3, "use baidu network provider"
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider_baidu:Lcom/android/server/location/LocationProviderProxy;

    .line 579
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider_baidu:Lcom/android/server/location/LocationProviderProxy;
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider:Lcom/android/server/location/LocationProviderProxy;

    .line 581
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    iget-object v3, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->fusedLocationProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v3, "fused location provider found"
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->mGeocodeProvider_baidu:Lcom/android/server/location/GeocoderProxy;
    ...
    iget-object v2, v0, Lcom/android/server/LocationManagerService;->mGeocodeProvider_baidu:Lcom/android/server/location/GeocoderProxy;
    ...
    const-string v3, "use baidu geocode provider"
    ...
    .line 683
    .local v10, "flpHardwareProvider":Lcom/android/server/location/FlpHardwareProvider;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v10}, Lcom/android/server/location/FlpHardwareProvider;->getLocationHardware()Landroid/hardware/location/IFusedLocationHardware;
    ...
    invoke-virtual {v10}, Lcom/android/server/location/FlpHardwareProvider;->getGeofenceHardware()Landroid/location/IFusedGeofenceHardware;
    ...
    .line 702
    .local v17, "provider":Lcom/android/server/location/GeofenceProxy;
    if-nez v17, :cond_9
    ...
    .line 555
    .end local v10    # "flpHardwareProvider":Lcom/android/server/location/FlpHardwareProvider;
    .end local v11    # "fusedProxy":Lcom/android/server/location/FusedProxy;
    .end local v17    # "provider":Lcom/android/server/location/GeofenceProxy;
    :cond_b
    move-object/from16 v0, p0
    ...
    const-string v3, "use amap network provider"
    ...
    const-string v3, "use google network provider"
    ...
    const-string v3, "use amap geocode provider"
    ...
    const-string v3, "use google geocode provider"
    ...
    .line 713
    .restart local v10    # "flpHardwareProvider":Lcom/android/server/location/FlpHardwareProvider;
    .restart local v11    # "fusedProxy":Lcom/android/server/location/FusedProxy;
    .restart local v17    # "provider":Lcom/android/server/location/GeofenceProxy;
    :cond_12
    const/4 v2, 0x0
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    const-string v6, "GPS disabled, please turn on GPS and try again."
    ...
    invoke-virtual {v5, v9}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->removeMessages(I)V

    .line 1778
    iget-object v5, p0, Lcom/android/server/LocationManagerService;->mLocationHandler:Lcom/android/server/LocationManagerService$LocationWorkerHandler;

    invoke-virtual {v5, v9}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendEmptyMessage(I)Z
...
.method public locationCallbackFinished(Landroid/location/ILocationListener;)V
    ...
    invoke-static {v3}, Lcom/android/server/LocationManagerService$Receiver;->access$1800(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method public systemRunning()V
    ...
    .line 327
    .local v7, "mPhoneStateListener":Landroid/telephony/PhoneStateListener;
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v0, v7, v2}, Landroid/telephony/TelephonyManager;->listen(Landroid/telephony/PhoneStateListener;I)V
    ...
    invoke-direct {v2, p0, v5}, Lcom/android/server/LocationManagerService$3;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V
    ...
    .end local v7    # "mPhoneStateListener":Landroid/telephony/PhoneStateListener;
    :catchall_0
    move-exception v0
