...
# static fields
.field private static final ACTION_NOTIFY_LED_UPDATE:Ljava/lang/String; = "yulong.intent.action.NOTIFY_LED_UPDATE"

.field private static final ACTION_SHOWNUM_CHANGED:Ljava/lang/String; = "yulong.intent.action.SHOW_NUM_CHANGED"

.field private static final ACTION_UNCONVENTIONALITY_RING:Ljava/lang/String; = "yulong.intent.action.unconventionality.ring"
...
.field private enableAdjustCpuNormal:I
...
.field private isUnconventionalityRing:I
...
.field private final mShutDownIfNoBatteryRunnable:Ljava/lang/Runnable;
...
.field private recoardEnableAdjustCpuNormal:I

.field private showNum:I

.field private ylBreathLightCallColor:I

.field private ylBreathLightCallSwitch:Z
...
.field private ylBreathLightMessageColor:I

.field private ylBreathLightMessageSwitch:Z

.field private ylBreathLightNotify:Z

.field private ylNotifyLightCallColor:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 158
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBooted:Z

    .line 159
    iput-object v6, p0, Lcom/android/server/BatteryService;->mTempDlg:Landroid/app/AlertDialog;

    .line 160
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mShowShutdownDialog:Z

    .line 161
    new-instance v2, Lcom/android/server/BatteryService$DialogHandler;

    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$DialogHandler;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v2, p0, Lcom/android/server/BatteryService;->mDialogHandler:Lcom/android/server/BatteryService$DialogHandler;

    .line 178
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->haveUnreadMsg:Z

    .line 179
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->haveMissedCall:Z

    .line 181
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->isScreenOn:Z

    .line 182
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mNotifyLedOn:Z
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->handler:Landroid/os/Handler;

    .line 218
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->ylBreathLightCallSwitch:Z

    .line 219
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->ylBreathLightMessageSwitch:Z
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mShutDownIfNoBatteryRunnable:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, Lcom/android/server/BatteryService;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v5, "yulong.intent.action.SHOW_NUM_CHANGED"
    ...
    const-string v5, "yulong.intent.action.NOTIFY_LED_UPDATE"
    ...
    const-string v5, "yulong.intent.action.unconventionality.ring"
    ...
    .line 273
    :cond_0
    new-instance v2, Lcom/android/server/AssistantBatteryService;

    invoke-direct {v2, p1}, Lcom/android/server/AssistantBatteryService;-><init>(Landroid/content/Context;)V

    .line 281
    new-instance v1, Lcom/android/server/BatteryService$SettingsObserver;

    iget-object v2, p0, Lcom/android/server/BatteryService;->handler:Landroid/os/Handler;
    ...
    .line 282
    .local v1, "settingsObserver":Lcom/android/server/BatteryService$SettingsObserver;
    invoke-virtual {v1}, Lcom/android/server/BatteryService$SettingsObserver;->RegisterObserverAndUpdateSettings()V
    ...
    iput-object v2, p0, Lcom/android/server/BatteryService;->mPowerClient:Lcom/yulong/android/power/PowerClient;

    .line 291
    new-instance v2, Lcom/android/server/BatteryService$BatteryListener;

    invoke-direct {v2, p0, v6}, Lcom/android/server/BatteryService$BatteryListener;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V
...
.method private final BatteryCpuUpdate()V
    .locals 5
    ...
    .line 1712
    iget-boolean v1, p0, Lcom/android/server/BatteryService;->mBooted:Z

    if-eqz v1, :cond_2

    iget v1, p0, Lcom/android/server/BatteryService;->enableAdjustCpuValue:I
    ...
    iget v2, p0, Lcom/android/server/BatteryService;->lowBatteryValue:I

    if-lt v1, v2, :cond_1

    :cond_0
    iget v1, p0, Lcom/android/server/BatteryService;->enableAdjustCpuNormal:I
    ...
    .line 1718
    .local v0, "Data":[I
    iget-object v1, p0, Lcom/android/server/BatteryService;->mPowerClient:Lcom/yulong/android/power/PowerClient;
    ...
    const-string v2, "   Battery Cpu Update    "
...
.method static synthetic access$1300(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 99
    iget v0, p0, Lcom/android/server/BatteryService;->isUnconventionalityRing:I
...
.method static synthetic access$1302(Lcom/android/server/BatteryService;I)I
    ...
    .prologue
    .line 99
    iput p1, p0, Lcom/android/server/BatteryService;->isUnconventionalityRing:I
...
.method static synthetic access$1500(Lcom/android/server/BatteryService;)Z
    ...
    .prologue
    .line 99
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->ylBreathLightCallSwitch:Z
...
.method static synthetic access$1502(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 99
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->ylBreathLightCallSwitch:Z
...
.method static synthetic access$1700(Lcom/android/server/BatteryService;)Z
    ...
    .prologue
    .line 99
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->ylBreathLightMessageSwitch:Z
...
.method static synthetic access$1702(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 99
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->ylBreathLightMessageSwitch:Z
...
.method static synthetic access$2000(Lcom/android/server/BatteryService;)Z
    ...
    .prologue
    .line 99
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mNotifyLedOn:Z
...
.method static synthetic access$2002(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 99
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->mNotifyLedOn:Z
...
.method static synthetic access$2902(Lcom/android/server/BatteryService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;
    .param p1, "x1"    # I
...
.method static synthetic access$3100(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 99
    iget v0, p0, Lcom/android/server/BatteryService;->enableAdjustCpuNormal:I
...
.method static synthetic access$3102(Lcom/android/server/BatteryService;I)I
    ...
    .prologue
    .line 99
    iput p1, p0, Lcom/android/server/BatteryService;->enableAdjustCpuNormal:I
...
.method static synthetic access$3200(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 99
    iget v0, p0, Lcom/android/server/BatteryService;->recoardEnableAdjustCpuNormal:I
...
.method static synthetic access$3202(Lcom/android/server/BatteryService;I)I
    ...
    .prologue
    .line 99
    iput p1, p0, Lcom/android/server/BatteryService;->recoardEnableAdjustCpuNormal:I

    return p1
.end method

.method static synthetic access$3300(Lcom/android/server/BatteryService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;

    .prologue
    .line 99
    invoke-direct {p0}, Lcom/android/server/BatteryService;->BatteryCpuUpdate()V

    return-void
.end method

.method static synthetic access$3400(Lcom/android/server/BatteryService;Landroid/os/BatteryProperties;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method static synthetic access$500(Lcom/android/server/BatteryService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;
    .param p1, "x1"    # Z
...
.method static synthetic access$600(Lcom/android/server/BatteryService;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method static synthetic access$602(Lcom/android/server/BatteryService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method private processValuesLocked()V
    ...
    .line 603
    :goto_2
    invoke-direct {p0}, Lcom/android/server/BatteryService;->shutdownIfNoBatteryLocked()V
...
.method private shutdownConfirm(Z)V
    ...
    invoke-virtual {v2, v6}, Lcom/android/server/BatteryService$DialogHandler;->removeMessages(I)V

    .line 1403
    iget-object v2, p0, Lcom/android/server/BatteryService;->mDialogHandler:Lcom/android/server/BatteryService$DialogHandler;

    invoke-virtual {v2, v6}, Lcom/android/server/BatteryService$DialogHandler;->sendEmptyMessage(I)Z
    ...
    const-string v3, " discharing : shutdown when batterylevel < 5 && voltage less-then 3.4V  "
...
.method private shutdownIfNoBatteryLocked()V
    .locals 4
    ...
    iget-object v1, p0, Lcom/android/server/BatteryService;->mShutDownIfNoBatteryRunnable:Ljava/lang/Runnable;
...
.method private update(Landroid/os/BatteryProperties;)V
    ...
    const-string v2, "yulong.sys.battery.level"
    ...
    iput v2, v0, Landroid/os/BatteryProperties;->batteryLevel:I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v7, "  isFactoryBreathLightTest : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Lcom/android/server/BatteryService;->isFactoryBreathLightTest:Z
    ...
    const-string v7, "  isUnconventionalityRing : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/BatteryService;->isUnconventionalityRing:I
    ...
    const-string v7, "  ylBreathLightDisturb : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/BatteryService;->ylBreathLightDisturb:I
    ...
    const-string v7, "  ylBreathLightNotify : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->ylBreathLightNotify:Z
    ...
    const-string v7, "  ylBreathLightLowpower : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->ylBreathLightLowpower:Z
    ...
    const-string v7, "  ylBreathLightCharging : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->ylBreathLightCharging:Z
    ...
    const-string v7, "  haveMissedCall : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->haveMissedCall:Z
    ...
    const-string v7, "  haveUnreadMsg : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->haveUnreadMsg:Z
    ...
    const-string v7, "  ylBreathLightCallSwitch : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->ylBreathLightCallSwitch:Z
    ...
    const-string v7, "  ylBreathLightMessageSwitch : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/BatteryService;->ylBreathLightMessageSwitch:Z
    ...
    const-string v7, "  enableAdjustCpuValue : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/BatteryService;->enableAdjustCpuValue:I
    ...
    const-string v7, "  lowBatteryValue : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/BatteryService;->lowBatteryValue:I
